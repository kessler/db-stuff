...
RedshiftBulkInsert.prototype.insert = function(row, insertDoneCallback) {
	...
	this._fileWriter.write(text + NEWLINE, insertDone);		
...
RedshiftBulkInsert.prototype._deleteLocalFile = function (flushOp) {
	var self = this;
	
	return function(callback) {		
		fs.unlink(flushOp.filename, callback);		
	};
};
