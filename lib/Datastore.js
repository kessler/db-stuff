...
var Insert = require('./Datastore.Insert');
...
*/
PostgresDatastore.prototype.query = function(sql, callback) {	
	pg.connect(this.config.connectionString, function(err, client, done) {
		if (err === null) {

			var query = client.query(sql, callback);
...
*/
PostgresDatastore.prototype.createQuery = function(sql, callback) {
	pg.connect(this.config.connectionString, function(err, client, done) {
		if (err === null) {
